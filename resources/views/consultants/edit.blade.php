        ...
        <div class="bg-[#1A1C24] p-6 w-full max-w-screen-lg">
            ...
            <form action="{{ route('consultants.update', $consultant->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" class="w-full p-2 mt-2 bg-gray-800 text-white">{{ $consultant->company }}</textarea>
                </div>
                <div class="mb-4">
                    <label class="block text-white" for="solution">Solution</label>
                    <textarea name="solution" id="solution" class="w-full p-2 mt-2 bg-gray-800 text-white">{{ $consultant->role }}</textarea>
                </div>
